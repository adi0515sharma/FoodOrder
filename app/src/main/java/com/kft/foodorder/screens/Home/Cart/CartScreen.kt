package com.kft.foodorder.screens.Home.Cart
...
import com.kft.foodorder.ui.Components.CartItemComponent
import com.kft.foodorder.ui.Components.FoodItemComponent


@Composable
fun CartScreen(
    cartList : List<FoodDB>,

    navigateDetails: (String) -> Unit,
    navigateBack : () -> Unit,
    cartAction : (CART_ACTION, FoodDB) -> Unit
){
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        LazyColumn(
            ...
            itemsIndexed(cartList) { index, item ->
                CartItemComponent(modifier = Modifier, foodDB = item, {
                    navigateDetails("${AppScreens.DetailPage.route}/${item.meal_id}")
                }) { it: CART_ACTION ->
                    cartAction(it, item)
                }
